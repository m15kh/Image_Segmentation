...
from net import ConvAutoEncoder  # Assuming the model is defined in model.py
...
model.load_state_dict(torch.load('/home/ubuntu/m15kh/own/book/Gans/autoencoder/cnn-autoencoder/checkpoints/model-convautoencoder.pth'))
model.eval()
